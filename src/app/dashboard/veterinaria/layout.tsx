...
export default function VeterinariaLayout({ children }: VeterinariaLayoutProps) {
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col bg-card">
      ...
      <div className="flex h-16 items-center border-b px-6 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent">
    ...
    <AuthGuard requiredRoles={['VETERINARIA', 'ADMIN']}>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          {/* Page Content */}
          <main className="flex-1 overflow-y-auto bg-gradient-to-br from-background via-background to-muted/20 p-4 lg:p-6">
