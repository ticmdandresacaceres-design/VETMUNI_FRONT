...
import { MoreHorizontal, Trash2, Eye, Phone, Mail, IdCard, Plus, Edit, Users, UserCheck } from "lucide-react"
import {
  Table,
  TableBody,
  TableCell,
...
export default function DuenosList() {
  ...
  const validDuenos = Array.isArray(duenos) ? duenos : []
  const displayDuenos = filteredDuenos.length > 0 ? filteredDuenos : validDuenos
          ...
          <CardHeader className="pb-3">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <DuenoFilters duenos={validDuenos} onFilterChange={setFilteredDuenos} />
          ...
          <CardContent>
              ...
              <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/40 border">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xl font-bold">
                    {validDuenos.filter(d => d.active).length}
                  </p>
                </div>
              </div>
            </div>
            ...
            {displayDuenos.length > 0 && (
              <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm text-muted-foreground">
                <p>
                  Mostrando <span className="font-medium text-foreground">{displayDuenos.length}</span> de {validDuenos.length} propietario{validDuenos.length !== 1 ? 's' : ''}
                </p>
                <p className="text-xs">
